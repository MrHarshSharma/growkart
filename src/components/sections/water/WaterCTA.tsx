...
import { waterCity, waterMockupLink } from "@/data/water";
...
export default function WaterCTA() {
  ...
  return (
    <section id="water-contact" ref={ref} className="bg-[#FAF3E8] w-full">
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-16 py-20 lg:py-28">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7">
            ...
            >
              <span className="w-5 h-px bg-[#0D1B3E]/40" /> Free Mockup
            </motion.p>
            ...
            <motion.p
              className="text-[#0D1B3E]/60 text-base leading-relaxed max-w-lg"
              initial={{ opacity: 0, y: 16 }}
              animate={inView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.55, delay: 0.16, ease: "easeOut" }}
            >
              Send us your logo on WhatsApp and we&apos;ll design your label and show
              you the bottle — free, and with no obligation to order. If we built your
              website, we already have everything we need.
            </motion.p>
          </div>
          ...
          >
            ...
            <p className="text-[#FAF3E8]/60 text-sm leading-relaxed mb-4">
              Serving {waterCity} and nearby areas on fixed weekly delivery routes.
            </p>
